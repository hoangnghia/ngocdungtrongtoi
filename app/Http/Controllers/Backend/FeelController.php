...
class FeelController extends Controller
{
    ...
    {
        $post = new Feels();
        return view('feel/create', ['post' => $post]);
    }
    ...
    public function createFeel(Request $request)
    {
        ...
        Session::flash('flash_message', "Thêm cảm nhận thành công");
        return $this->index();
    }
    ...
    public function editFeel($id = '')
    {
        ...
        return view('feel/edit', ['news' => $news]);
    }
