...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <br>
                <form id="demo-form2"  action="{{url('/culture/createCulture')}}" class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="col-md-11 col-sm-11 col-xs-12">
                            <select id="group" name="type" class="form-control input-md">
                                ...
                                @foreach(\App\Models\Culture::TYPE as $key => $item)
                                    <option value="{{$key}}">
                                        {{$item}}
                                    </option>
                                @endforeach
