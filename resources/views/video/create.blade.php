    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="topbar-left">
            <ol class="breadcrumb">
                ...
                <li class="crumb-trail">Thêm video</li>
            </ol>
        </div>
        <div class="x_panel">
            <div class="x_title">
            ...
            <div class="x_content">
                <br>
                <form id="demo-form2"  action="{{url('/video/createPort')}}" class="form-horizontal form-label-left" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-11 col-sm-11 col-xs-12">
                            <input type="text" id="first-name" name="urlvideo" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                        ...
                        <div class="col-md-4">
                            <div class="fileupload fileupload-new admin-form" data-provides="fileupload">
                                <div class="fileupload-preview thumbnail mb20">
                                    <img src="" data-src="holder.js/100%x140" alt="holder">
                                </div>
                                <div class="row">
                                    <div class="col-xs-5">
