        ...
        <div class="x_panel">
            ...
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                    <li class="dropdown">
                        <a  class="btn btn-primary" href="{{url('/video/create')}}" >Thêm video</a>
                    </li>
                </ul>
    ...
    <script>
        $(document).ready(function(){
            $("#datatablebranch").dataTable({
                processing: true,
                serverSide: true,
                ajax: "<?php echo e(url('/video/getArrayData')); ?>",
                "columns": [
                    {
                    ...
                    },
                    {
                        data: 'id',  name: 'option', render: function (data) {
                            return '<ul class="nav navbar-right panel_toolbox"><li class="dropdown"><a href="/video/edit/' + data + '" class="dropdown-toggle" ><i class="fa fa-wrench"></i></a></li><li><a href="/video/delete/'+ data +'" class="close-link" value="'+data+'"><i class="fa fa-close"></i></a></li>'
                        }
                    }
